...
export const techBoundaries: TechBoundary[] = [
  {
    ...
    dimensions: [
      ...
      },
      {
        ...
        conditions: [
          {
            condition: '拥有独立、符合消防安全要求的专用设备机房，且空间充足',
            score: 1,
            isVeto: false,
          },
          {
            condition: '满足机房面积、层高、荷载需求有一定难度，但可操作',
            score: 0.5,
            isVeto: false,
          },
      ...
      },
      {
        ...
        conditions: [
          {
            condition: '仅配备基础的运维管理人员，仅具备基础的机房群控系统',
            score: 1,
            isVeto: false,
          },
          {
            condition: '仅配备基础的运维管理人员，无法独立支撑智能群控系统的日常调试与管理',
            score: 0.5,
            isVeto: false,
          },
          {
            condition: '配备专职暖通运维人员或专业运维团队，可支撑智能群控系统的日常调试与管理',
            score: 0,
            isVeto: false,
          },
        ],
      ...
      },
      {
        ...
        conditions: [
          {
            condition: '无数据采集条件且无法改造，无自控系统，靠人工就地操作',
            score: 0,
            isVeto: false,
          },
          {
            condition: '仅具备基础数据采集与网络基础，仅具备基础的机房群控系统',
            score: 0.5,
            isVeto: false,
          },
          {
            condition: '具备数据采集与网络基础，已具备完善的楼宇自控系统（BAS）',
            score: 1,
            isVeto: false,
          },
        ],
      },
      {
        ...
        conditions: [
          {
            condition:
              '空调水系统已按医疗区域分区设置（门诊、医技、病房、洁净、行政后勤、内区等）（解释：空调水系统已按医疗区域分区设置，洁净区（手术部、ICU/DSA、静脉配液等）已与舒适性空调区（门诊、医技、病房、行政后勤等）分开独立设置）',
            score: 1,
            isVeto: false,
          },
  ...
  },
  {
    ...
    dimensions: [
      ...
      },
      {
        ...
        conditions: [
          {
            condition: '有集中式冷水系统，冷源主机投产年份距今＞15年，无冷凝热回收',
            score: 1,
            isVeto: false,
          },
          {
  ...
  },
  {
    ...
    dimensions: [
      ...
      },
      {
        ...
        conditions: [
          {
            condition: '有集中式冷水系统，有冷却塔（如冷机+风盘），且无冷却塔供冷',
            score: 1,
            isVeto: false,
          },
          {
            condition:
              '有集中式冷水系统，无冷却塔（如热泵+风盘）（注意：此条针对集中式冷源中，地源热泵、空气源热泵、风冷热泵这三个没有冷却塔的情况,当集中式冷源仅选择这三个时，此技术不适用)',
            score: 0,
            isVeto: true,
          },
      ...
      },
      {
        ...
        conditions: [
          {
            condition:
              '空调水系统已按医疗区域分区设置（门诊、医技、病房、洁净、行政后勤、内区等）（解释：空调水系统已按医疗区域分区设置，洁净区（手术部、ICU/DSA、静脉配液等）已与舒适性空调区分开独立设置），且有独立的内区环路',
            score: 1,
            isVeto: false,
          },
          {
            condition: '空调水系统有分区，且洁净区已独立设置，但建筑内区未独立设置',
            score: 0.5,
            isVeto: false,
          },
    ...
    dimensions: [
      ...
      },
      {
        ...
        conditions: [
          ...
          {
            condition: '集中式蒸汽系统基本完善，已设置冷凝水干管，需局部新增收集支管',
            score: 0.5,
            isVeto: false,
          },
      ...
      },
      {
        ...
        conditions: [
          ...
          {
            condition: '污染冷凝水与优质冷凝水可通过简单改造实现分质收集',
            score: 0.5,
            isVeto: false,
          },
    ...
    dimensions: [
      ...
      },
      {
        ...
        conditions: [
          ...
          {
            condition: '0.5元/kWh≤峰谷电价差＜0.7元/kWh、低谷电时长≥8h',
            score: 0.5,
            isVeto: false,
          },
      ...
      },
      {
        ...
        conditions: [
          ...
          {
            condition: '满足蓄冷场地空间、荷载需求有一定难度，但可操作',
            score: 0.5,
            isVeto: false,
          },
      ...
      },
      {
        ...
        conditions: [
          ...
          {
            condition: '有集中式冷水系统，且有蓄冷系统。或无集中式空调系统',
            score: 0,
            isVeto: true,
          },
        ],
    ...
    dimensions: [
      {
        ...
        conditions: [
          ...
          {
            condition: '洁净区域总建筑面积800~1500㎡，且洁净手术室4~10间',
            score: 0.5,
            isVeto: false,
          },
      ...
      },
      {
        ...
        conditions: [
          {
            condition:
              '综合医院、专科医院、中医/中西医结合医院、民族医院（集门诊、医技、住院于一体）',
            score: 1,
            isVeto: false,
          },
          {
            condition:
              '康复医院、疗养院、老年病医院（以住院康养为主）、综合门诊部、医学检验实验室、急救中心',
            score: 0.5,
            isVeto: false,
          },
      ...
      },
      {
        ...
        conditions: [
          {
            condition: '洁净区域有独立的冷热源机组，但无热回收功能，使用年限≥10年',
            score: 1,
            isVeto: false,
          },
          {
    ...
    dimensions: [
      ...
      },
      {
        ...
        conditions: [
          ...
          {
            condition: '0.5元/kWh≤峰谷电价差＜0.6元/kWh、低谷电时长≥8h',
            score: 0.5,
            isVeto: false,
          },
          { condition: '峰谷电价差＜0.5元/kWh', score: 0, isVeto: true },
      ...
      },
      {
        ...
        conditions: [
          ...
          {
            condition: '满足储能场地空间、荷载需求有一定难度，但可操作',
            score: 0.5,
            isVeto: false,
          },
    ...
    dimensions: [
      ...
      },
      {
        ...
        conditions: [
          ...
          {
            condition: '康复医院、疗养院、老年病医院（以住院康养为主）',
            score: 0.5,
            isVeto: false,
          },
          {
            condition: '急救中心、综合门诊部、医学检验实验室、社区卫生服务中心',
            score: 0,
            isVeto: true,
          },
        ],
  ...
  },
  {
    ...
    dimensions: [
      ...
      },
      {
        ...
        conditions: [
          {
            condition: '寒冷地区、夏热冬冷地区（地源+空气源+锅炉+太阳能等，能效高）',
            score: 1,
            isVeto: false,
          },
          {
            condition: '夏热冬暖地区、温和地区（空气源+太阳能等，不做地源，能效中等）',
            score: 0.5,
            isVeto: false,
          },
          {
            condition: '严寒地区（空气源结霜严重，地源+锅炉+太阳能，能效稍低）',
            score: 0,
            isVeto: false,
          },
        ],
      },
      {
        ...
        conditions: [
          {
            condition: '有节能/可再生能源利用等能源相关政策，且有财政专项补贴',
            score: 1,
            isVeto: false,
          },
          {
            condition: '有节能/可再生能源利用等能源相关政策，暂无财政专项补贴',
            score: 0.5,
            isVeto: false,
          },
          { condition: '无节能/可再生能源利用等能源相关政策', score: 0, isVeto: false },
      ...
      },
      {
        ...
        conditions: [
          {
            condition: '有室外场地条件用于地源换热井，面积≥18%院区地上建筑面积',
            score: 1,
            isVeto: false,
          },
          {
            condition: '有室外场地条件用于地源换热井，8%≤面积＜18%院区地上建筑面积',
            score: 0.75,
            isVeto: false,
          },
          {
            condition:
              '有室外场地条件用于地源换热井，面积＜8%院区地上建筑面积；或无室外场地条件用于地源换热井',
            score: 0,
            isVeto: false,
          },
        ],
    ...
    dimensions: [
      ...
      },
      {
        ...
        conditions: [
          ...
          { condition: '安装条件有限，需采用有线和无线结合的控制方案', score: 0.5, isVeto: false },
          {
            condition: '有线和无线均无安装条件（老旧管线混乱、回路复杂）',
            score: 0,
            isVeto: false,
          },
        ],
      ...
      },
      {
        ...
        conditions: [
          {
            condition:
              '一级适配区（门诊大厅、候诊区、病房走廊、护士站、地下车库、行政办公区、景观区域）、二级适配区（普通病房、术后康复区、治疗/换药、科室办公室）均未实现智能照明',
            score: 1,
            isVeto: false,
          },
          {
            condition: '一级适配区和二级适配区小于一半区域已实现智能照明（＜6/11）',
            score: 0.5,
            isVeto: false,
          },
          {
            condition: '一级适配区和二级适配区超过一半区域已实现智能照明（≥6/11）',
            score: 0,
            isVeto: true,
          },
        ],
      },
      {
        ...
        conditions: [
          {
            condition: '集中式照明回路完善，具备分区域、分回路控制的物理基础',
            score: 1,
            isVeto: false,
          },
