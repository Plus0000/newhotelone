...
export function isMunicipality(location: string): boolean {
  return MUNICIPALITIES.some((m) => location.startsWith(m));
}

/** 从省市数组中提取省份名 */
export function getProvince(locationArr: string[]): string {
